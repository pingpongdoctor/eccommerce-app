...
export default function ReviewsSkeletonComponent() {
  return (
    <ul className="max-h-[700px] w-full animate-pulse list-none overflow-auto lg:max-h-[505px] [&>div]:border-b">
      {[1, 2].map((ele) => (
        <li
          key={ele}
          className="flex flex-col gap-4 px-4 py-8 last:border-none last:pb-0 lg:first:pt-0"
        >
