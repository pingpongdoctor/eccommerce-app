...
export default async function AdminPage() {
  ...
  return (
    <div className="cursor-default px-4 md:px-8 lg:px-12 xl:mx-auto xl:max-w-7xl">
      {/* column name */}
      <div className="flex justify-between border-b-[2px] border-gray-200 p-4 font-medium text-gray-700 *:text-center">
